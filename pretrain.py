...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', default='/kaggle/input/blip-pretraining/Blip4/output/Pretrain/checkpoint_02.pth')    
    ...
    config['train_file']=['karpathy_train.json'] # path to training file [{'image':image_full_path.jpg','caption':'caption1'},{...}]
